...
Interface IRequest_Handler
    ReadOnly Property get_request_handlers As Dictionary(Of Byte, Action(Of USBDeviceRequest))
End Interface
Interface IRequest_Recipient
    Inherits IRequest_Handler
    ReadOnly Property get_device_class As USBClass
    ReadOnly Property get_device_vendor As USBVendor
End Interface
