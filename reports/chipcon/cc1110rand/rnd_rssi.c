...
void initrnd(){
  ...
  /*
  //Default FREQ, 2.4GHz too big for 1110.
  //Will be reset by hardware to default, 0x1EC4EC
  ...
  */
  FREQ2     = 0x1E;   // Frequency control word, high byte.
  FREQ1     = 0xC4;   // Frequency control word, middle byte.
...
int rndu16(){
  ...
  /* //Default implementation clocks LFSR to whiten.
  seed=RSSI;
  RNDL = seed;
  RNDL = seed;
